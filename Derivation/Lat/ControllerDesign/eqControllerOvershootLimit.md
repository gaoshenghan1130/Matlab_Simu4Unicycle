...
## Exact Force-Eliminated Relation

An exact relation independent of the explicit value of $F$ can also be obtained.

From the second equation of motion,

$$
F=m\dot u_2+mg\sin\theta-mru_1^2.
$$
...
J(r)\dot u_1
={}&
mR\dot u_2+mgR\sin\theta-mRru_1^2\\
&-mgr\cos\theta+G\sin\theta
-mr(2u_2u_1+Ru_1^2).
\end{aligned}
$$

The velocity-dependent terms satisfy

$$
-mRru_1^2-mr(2u_2u_1+Ru_1^2)
=
-2mru_1(u_2+Ru_1).
$$
...
$$
\dot u_2=\ddot r-R\ddot\theta,
$$

this becomes

$$
\left(J(r)+mR^2\right)\ddot\theta-mR\ddot r
=
(G+mgR)\sin\theta-mgr\cos\theta
-2mr\dot\theta\dot r.
$$
...
\left[
\left(J(r)+mR^2\right)\dot\theta-mR\dot r
\right]
={}&
\left(J(r)+mR^2\right)\ddot\theta\\
&+2mr\dot r\dot\theta-mR\ddot r.
\end{aligned}
$$

Substituting the acceleration relation causes the two velocity-dependent terms to cancel. Hence,
...
This identity is exact and shows that the control force does not appear directly in the evolution of $p$. It is not necessary to assume $p=0$ to obtain the force-dominated local direction.
